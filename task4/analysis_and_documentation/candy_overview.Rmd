...
- Using the `rating system` to calulate the `joy_vs_despair_rating` for each type of M&M we can see that the Mint M&Ms must have brought a lot of *despair* to lower their `joy_vs_despair_rating` to -88.
